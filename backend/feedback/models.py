...
class FeedbackForm(models.Model):
    ...
    organization = models.ForeignKey(
        Organization, on_delete=models.CASCADE, related_name="feedback_forms"
    )
...
class FeedbackQuestion(models.Model):
    ...
    options = models.JSONField(
        blank=True, null=True, help_text="List of choices for RADIO and CHECKBOX types"
    )
...
class ProjectFeedback(models.Model):
    ...
    form = models.ForeignKey(
        FeedbackForm, on_delete=models.CASCADE, related_name="project_links"
    )
    public_id = models.CharField(
        max_length=50, default=generate_short_id, editable=False, unique=True
    )
...
class FeedbackResponse(models.Model):
    id = models.AutoField(primary_key=True)
    project_feedback = models.ForeignKey(
        ProjectFeedback, on_delete=models.CASCADE, related_name="responses"
    )
