...
class FeedbackResponseAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_feedback', 'client_name', 'client_email', 'submitted_at')
...
class FeedbackAnswerAdmin(admin.ModelAdmin):
    ...
    search_fields = ('response__client_name', 'response__client_email', 'question__question_text')
