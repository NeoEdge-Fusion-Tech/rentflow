...
def add_quantity_returned_good_if_missing(apps, schema_editor):
    ...
    columns = [
        col.name
        for col in db.introspection.get_table_description(
            db.cursor(), "inventory_bookingitemunit"
        )
    ]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "inventory",
            "0013_rename_quantity_returned_bookingitemunit_quantity_returned_damaged_and_more",
        ),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(
            add_quantity_returned_good_if_missing, migrations.RunPython.noop
        ),
