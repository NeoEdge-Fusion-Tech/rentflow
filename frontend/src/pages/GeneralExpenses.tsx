      ...
      const payload = {
        ...
        vendor:
          formData.expense_type === "vendor"
            ? parseInt(String(formData.vendor))
            : null,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[var(--text-muted)]">
            Track organization-wide expenses not linked to specific projects.
          </p>
        </div>
        <button
            ...
            >
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, expense_type: "item" })
                  }
                  className={cn(
                    "py-2.5 rounded-xl border font-bold text-sm transition-colors",
                    formData.expense_type === "item"
