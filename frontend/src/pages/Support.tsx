...
export function Support() {
  ...
  const [activeTab, setActiveTab] = useState<"contact" | "feedback" | "rate">(
    "contact",
  );
        ...
        <div className="p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
              ...
              <>
                <div>
                  ...
                  <p className="text-sm text-[var(--text-muted)] mb-6">
                    Need help with something? Send us a message and our support
            ...
            {activeTab === "feedback" && (
              <>
                <div>
                  ...
                  <p className="text-sm text-[var(--text-muted)] mb-6">
                    Have an idea for a new feature? Or something you'd like us
                    to improve? Let us know!
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-bold text-[var(--text-muted)] mb-1.5">
              ...
              <>
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-[var(--text-muted)] mb-8">
                    Tap a star to rate your experience with NeoOps.
                  </p>
            ...
            <button
              type="submit"
              disabled={
                isSubmitting || (activeTab === "rate" && formData.rating === 0)
              }
