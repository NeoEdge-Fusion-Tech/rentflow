  ...
  const hints = [
    {
      ...
      content:
        "This platform helps you manage your rentals and bookings efficiently. Let's take a quick tour.",
    },
    {
      title: "Inventory Management",
      content:
        "Navigate to the Inventory tab to add your products, set pricing, and manage stock levels.",
    },
    {
      title: "Track Bookings",
      content:
        "Use the Bookings section to see upcoming rentals, approve requests, and monitor returns.",
    },
    {
      title: "Invoices & Payments",
      content:
        "Easily generate invoices from bookings and keep track of all your client payments.",
    },
    {
      title: "Client Feedback",
      content:
        "Gather reviews using the Feedback Forms module to improve your services.",
    },
    {
      title: "Get Started",
      content:
        "You're all set! Start by adding your first item to the inventory or creating a booking.",
    },
  ];
