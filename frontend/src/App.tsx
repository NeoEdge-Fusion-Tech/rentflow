                    ...
                    {notifications.length === 0 ? (
                      ...
                      notifications.map((notif: any) => (
                        <div
                          ...
                          className={`p-4 border-b border-[var(--border-subtle)] last:border-0 hover:bg-[var(--bg-app)] transition-colors cursor-pointer ${
                            notif.is_read ? "opacity-70" : "bg-brand-primary/5"
                          }`}
                        >
                          <p
                            className={`text-sm ${
            ...
            <div className="p-6">
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-[var(--text-muted)] mb-1">
                    Email{" "}
                    <span className="text-[var(--text-muted)] opacity-60 font-normal">
                  ...
                  <input
                    ...
                    disabled
                    className="w-full border border-[var(--border-soft)] rounded-xl p-2.5 outline-none bg-[var(--bg-app)] opacity-60 text-[var(--text-main)]"
                  />
                </div>
                ...
                <div className="pt-4 flex justify-end gap-3 border-b border-[var(--border-soft)] pb-6">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2.5 bg-brand-primary text-white font-medium rounded-xl hover:opacity-90 transition-opacity shadow-sm"
                  >
                    Save Changes
                  </button>
                </div>
              ...
              <div className="mt-6 pt-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-rose-500/10 text-rose-500 font-bold rounded-xl border border-rose-500/20 hover:bg-rose-500/20 transition-colors"
                >
                  Delete My Account
                </button>
              </div>
