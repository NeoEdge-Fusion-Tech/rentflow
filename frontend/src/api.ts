...
export const ProductService = {
  ...
  getAvailability: (
    ...
    start_date: string,
    end_date: string,
    exclude_booking_id?: number | string,
  ) =>
    api.get(`/inventory/products/${id}/availability/`, {
      params: { start_date, end_date, exclude_booking_id },
    }),
  scan: (data: {
...
export const BookingService = {
  ...
  update: (id: number | string, data: any) =>
    api.put(`/inventory/bookings/${id}/`, data),
...
export const ClientService = {
  ...
  update: (id: number | string, data: any) =>
    api.patch(`/users/clients/${id}/`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
...
export const VendorService = {
  ...
  create: (data: any) =>
    api.post("/users/vendors/", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  update: (id: number | string, data: any) =>
    api.patch(`/users/vendors/${id}/`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
...
export const AuthService = {
  ...
  resendVerifyEmail: (data: { email: string }) =>
    api.post("/users/resend-verification-email/", data),
  triggerPasswordReset: (data: { email: string }) =>
    api.post("/users/password-reset/trigger/", data),
...
export const PaymentService = {
  ...
  createLink: (bookingId: number, amount: number) =>
    api.post("/payment/payments/create_payment_link/", {
  ...
  getOrganizationSubscription: () =>
    api.get("/payment/organization/subscription/"),
...
export const InvoiceService = {
  ...
  download: (id: number | string) =>
    api.get(`/payment/invoices/${id}/download/`, { responseType: "blob" }),
...
export const QuotationService = {
  ...
  update: (id: number | string, data: any) =>
    api.put(`/payment/quotations/${id}/`, data),
  patch: (id: number | string, data: any) =>
    api.patch(`/payment/quotations/${id}/`, data),
  delete: (id: number | string) => api.delete(`/payment/quotations/${id}/`),
  download: (id: number | string) =>
    api.get(`/payment/quotations/${id}/download/`, { responseType: "blob" }),
  convertToInvoice: (id: number | string) =>
    api.post(`/payment/quotations/${id}/convert_to_invoice/`),
...
export const ReceiptService = {
  ...
  update: (id: number | string, data: any) =>
    api.patch(`/payment/receipts/${id}/`, data),
  download: (id: number | string) =>
    api.get(`/payment/receipts/${id}/download/`, { responseType: "blob" }),
};
...
export const EventService = {
  ...
  update: (id: number | string, data: any) =>
    api.put(`/events/events/${id}/`, data),
  patch: (id: number | string, data: any) =>
    api.patch(`/events/events/${id}/`, data),
  delete: (id: number | string) => api.delete(`/events/events/${id}/`),
  getDashboardStats: (params?: any) =>
    api.get("/events/dashboard-stats/", { params }),
  getMonthlyBreakdown: (params?: any) =>
    api.get("/events/monthly-breakdown/", { params }),
};
...
export const ExpenseService = {
  ...
  update: (id: number | string, data: any) =>
    api.patch(`/events/expenses/${id}/`, data),
  delete: (id: number | string) => api.delete(`/events/expenses/${id}/`),
  duplicate: (data: {
    target_event: number | string;
    source_event?: number | string;
    source_expense?: number | string;
  }) => api.post("/events/expenses/duplicate/", data),
};
...
export const GeneralExpenseService = {
  ...
  update: (id: string | number, data: any) =>
    api.patch(`/payment/general-expenses/${id}/`, data),
  delete: (id: string | number) =>
    api.delete(`/payment/general-expenses/${id}/`),
  getStats: (params?: any) =>
    api.get("/payment/general-expenses/stats/", { params }),
};
...
export const ChecklistTaskService = {
  ...
  update: (id: number | string, data: any) =>
    api.patch(`/events/checklist-tasks/${id}/`, data),
  ...
  duplicate: (sourceEvent: number | string, targetEvent: number | string) =>
    api.post("/events/checklist-tasks/duplicate/", {
      source_event: sourceEvent,
      target_event: targetEvent,
    }),
  download: (eventId: number | string) =>
    api.get("/events/checklist-tasks/download/", {
...
export const NotificationService = {
  ...
  markRead: (id: number) =>
    api.post(`/notification/notifications/${id}/mark_read/`),
...
export const CurrencyService = {
  ...
  update: (id: number | string, data: any) =>
    api.patch(`/users/currencies/${id}/`, data),
...
export const BankAccountService = {
  ...
  update: (id: number | string, data: any) =>
    api.patch(`/users/bank-accounts/${id}/`, data),
...
export const SuperAdminService = {
  ...
  getOrganizations: (params?: any) =>
    api.get("/users/superadmin/organizations/", { params }),
  getOrganization: (id: number | string) =>
    api.get(`/users/superadmin/organizations/${id}/`),
  createOrganization: (data: any) =>
    api.post("/users/superadmin/organizations/", data),
  updateOrganization: (id: number | string, data: any) =>
    api.patch(`/users/superadmin/organizations/${id}/`, data),
  deleteOrganization: (id: number | string) =>
    api.delete(`/users/superadmin/organizations/${id}/`),
  ...
  updateUser: (id: number | string, data: any) =>
    api.patch(`/users/superadmin/users/${id}/`, data),
  deleteUser: (id: number | string) =>
    api.delete(`/users/superadmin/users/${id}/`),
  setPassword: (id: number | string, data: { new_password: string }) =>
    api.post(`/users/superadmin/users/${id}/set_password/`, data),
  deactivateUser: (id: number | string) =>
    api.post(`/users/superadmin/users/${id}/deactivate/`),
};

export const SupportService = {
  submitFeedback: (data: {
    type: "feedback" | "contact" | "rating";
    rating?: number;
    subject?: string;
    message: string;
...
export const FeedbackService = {
  ...
  updateForm: (id: number | string, data: any) =>
    api.put(`/feedback/forms/${id}/`, data),
...
export const ProjectFeedbackService = {
  ...
  delete: (id: number | string) =>
    api.delete(`/feedback/project-feedbacks/${id}/`),
  getResponses: (id: number | string) =>
    api.get(`/feedback/project-feedbacks/${id}/responses/`),
};
